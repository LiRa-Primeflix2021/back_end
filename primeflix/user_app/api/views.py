...
from user_app.api.serializers import RegistrationSerializer, UpdateProfileSerializer
...
class UpdateProfile(APIView):
    ...
    def get(self, request):
        ...
        serializer = UpdateProfileSerializer(temp_user)
        return Response(serializer.data) 
    
    def put(self, request):
        temp_user = request.user
        request.data['username'] = temp_user.username
        serializer = UpdateProfileSerializer(temp_user, data=request.data)
        # data={}
        if(serializer.is_valid()):
            temp_user = serializer.save()
            # data['reponse'] = "Registration successful"
